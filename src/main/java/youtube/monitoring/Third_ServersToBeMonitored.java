...
public class Third_ServersToBeMonitored {
    private static String MembersNode = "/members";
    private static final Logger LOG = LoggerFactory.getLogger(Third_ServersToBeMonitored.class);
