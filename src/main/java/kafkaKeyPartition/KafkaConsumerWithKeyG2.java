...
// cd /Users/binod/Documents/software/kafka_2.13-3.0.0
// bin/zookeeper-server-start.sh ./config/zookeeper.properties
//bin/kafka-server-start.sh ./config/server.properties
// bin/kafka-topics.sh --create --topic key_partition_demo_topic  --bootstrap-server localhost:9092 --partitions 3 --replication-factor 1
// bin/kafka-topics.sh --list --bootstrap-server localhost:9092
// bin/kafka-console-consumer.sh --topic tagged-events  --bootstrap-server localhost:9092 --from-beginning

// Run Consumer on Terminal
// cd /Users/binod/Documents/Binod/Redis_All/Java_workspace/Zookeeper_Play
// source ~/.bash_profile
// mvn clean install
// mvn exec:java -Dexec.mainClass=kafkaKeyPartition.KafkaConsumerWithKeyG2



public class KafkaConsumerWithKeyG2 {

    private static final Logger log = LoggerFactory.getLogger(KafkaConsumerWithKeyG2.class);
    ...
    private static final String CONSUMER_GROUP_ID = "CG_2";
